    ...
    <>
      ...
      <div className="fixed z-50 top-0 right-0 h-full w-full max-w-md bg-bg-primary border-l border-accent-muted/30 shadow-warm-xl animate-slide-in-right flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
          {/* API Keys */}
          <section>
            <h3 className="font-body text-sm font-semibold text-text-tertiary uppercase tracking-wider mb-3">
              API Keys
            </h3>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 relative">
                        <input
                          ...
                          className="w-full bg-bg-secondary border border-accent-muted/40 rounded-xl px-3 py-2 text-base font-mono text-text-primary placeholder:text-text-tertiary placeholder:font-body focus:outline-none focus:border-accent-primary/60 transition-colors pr-8"
                        />
                        <button
                      ...
                      {status === 'validating' && (
                        <span className="text-sm text-text-tertiary animate-pulse">checking…</span>
                      )}
                      {status === 'valid' && (
